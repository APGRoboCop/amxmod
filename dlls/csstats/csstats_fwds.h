...
#ifndef csstats_fwds_h
#define csstats_fwds_h

#define FORWARD_NUM 8
...
public:
	...
	void executeForward( int type , int d1 );
	void executeForward( int type , int d1, int d2 );
