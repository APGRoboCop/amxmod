...
int loadModuleByMetamod(const char *path, void **handle, PLUG_LOADTIME now);
int unloadModuleByMetamod(void *handle);
...
public:
	...
	bool queryModule();
	bool detachModule();
	bool attachModuleToMetamod(const char *moduleFile, PLUG_LOADTIME now);
	...
	inline const char* getFileName() const { return filename.str(); }
	...
	inline bool isMetamod() { return metamod; }
	void pluginsLoaded();
